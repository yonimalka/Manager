...
<div class="footer">
  <div>
    ...
    This is an official receipt generated on ${new Date().toLocaleDateString(userLocale, {
      year: "numeric",
      month: "long",
      day: "numeric",
    })}
  ...
  <div style="margin-top:8px; font-size:9px; opacity:0.7;">
    Securely generated by 
    <span style="font-weight:700; color:${theme.primary}; letter-spacing:0.5px;">
      MAGGO
    </span>
    &bull; Business Management Platform
  </div>
</div>
` : ""}
